...
public class SlackController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse<SlackMessageResult>> createMessage(
			@Valid @RequestBody CreateSlackMessageRequest request) {

		SlackMessageResult response = slackService.createMessage(request.toCommand());
	...
	public ResponseEntity<ApiResponse<SlackMessageResult>> getMessage(@PathVariable UUID messageId) {
		SlackMessageResult response = slackService.getMessage(messageId);
		return ApiResponseEntity.success(response);
	}
